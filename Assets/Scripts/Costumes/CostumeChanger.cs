...
{    
    ...
    {
        foreach (var part in set.parts.targetObjects)
        {
            ...
            part.SetActive(true); // Aktifkan GameObject untuk bagian kostum ini
        }
...
public class CostumePart
{
    ...
    public List<GameObject> targetObjects; // List of GameObjects for this part
}
